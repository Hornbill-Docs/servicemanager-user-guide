...
When applying an email to a request, you'll see the new HAi Icon under the body of the email. Simply click the HAi icon on the right-hand side to process the email.
