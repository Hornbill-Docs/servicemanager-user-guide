...
| notes               | string      | optional     | Free Text Notes field (Maximum 255 Characters)                                                |
...
| ownedById           | string      | optional     | The userid of the user who owns the asset.                                                    |
...
| productId           | string      | optional     | The productid of the asset.                                                                   |
...
| supplierId          | string      | optional     | The supplierid of the asset.                                                                  |
| type                | string      | required     | The type of the asset.                                                          |
| usedById        | string     | optional     | The userid of the user who uses the asset.                                      |
...
| osVersion          | string         | optional      | Version of the installed Operating System  |
...
| IMSI Number        | Sring          | Optional      | IMSI number for mobile for asset           |
| MTPAS Access Class | String         | Optional      | MTPAS access class for asset               |
| SIM Type           | String         | Optional      | SIM Type for asset                         |
...
| MAC Address            | String | Optional | Mac address for the printer                   |
| wMAC Address           | String | Optional | wmac address for the printer                  |
...
| Cyan Toner Code        | String | Optional | Code for the black Cyan of the printer        |
...
| swVersion              | string         | optional      | The software version of the sset.           |
