...
## Changing Customer
Using the search subscriber option, you can select to search both the co-workers and contacts to find the customer to change to. The default position is to search both. Once a customer has been found, you can update the customer of the request using the Change Customer button.
